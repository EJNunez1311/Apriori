...
namespace Apriori
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (file == "")
            {
                Console.Write("Ruta de la transacción: ");
            ...
            {
                Console.WriteLine("Antecedente: " + item.Antecedente + " Consecuente: " + item.Consecuente + " Confianza: " + item.Confianza); //Imprime los resultados
            }
